...
Here is a comparison of test scenarios generated by Playwright compared to test scenarios generated by an actual person.
...
On the whole the AI agent picks up most scenarios and more edge case/usability tests that were missed by myself. The only 2 cons to using this tool from what I can see are:
