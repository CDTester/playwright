...
export abstract class BasePage {
   ...
   */
  async highlightElement( locator: Locator, highlightColor: string = 'gold', scrollIntoView: boolean = true  ) {
    // await locator.evaluate((element, { highlightColor, scrollIntoView }) => {
    ...
    // }, { highlightColor, scrollIntoView });

    scrollIntoView ? await locator.scrollIntoViewIfNeeded() : null;
    await locator.highlight({ style: `outline: 3px dashed ${highlightColor}`} );
