...
export class TodoPage extends BasePage {
  ...
  readonly urlCompleted: string;

  public constructor (page: Page, envData: any) {
    super(page)
    this.env = envData['playwrightDemo'];
    this.page = page;
    this.url=`${this.env.baseUrl}/todomvc/#/`;
    this.urlActive=`${this.env.baseUrl}/todomvc/#/active`;
    this.urlCompleted=`${this.env.baseUrl}/todomvc/#/completed`;
